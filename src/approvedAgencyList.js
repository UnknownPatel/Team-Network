...
const ApprovedAgencyList = () => {
  ...
  const handleRemove = async (agencyId) => {
    try {
      await axios
  ...
  return (
    <div>
      ...
      <section className="body-font ml-16 md:ml-60 ">
        ...
        <div className="text-center text-4xl mt-5">Approved Agency</div>
        <div
          id="block_report_viewport"
          className="flex flex-col mt-2 max-h-fit px-3"
        >
          <div>
            <div id="table-Agency-viewport" className="mt-5">
...
export default ApprovedAgencyList;
